...
//       }
//     }
//     final response = await callDbRequest(Uri.parse(url), createPayload(params));
//     return response;
//   }
...
//   Future<http.Response> callDbRequest(Uri url, Map payload) async {
//     SharedPreferences prefs = await SharedPreferences.getInstance();
//     var body = json.encode(payload);
//     _headers["Content-type"] = "application/json; charset=UTF-8";
//     _headers["Cookie"] = prefs.getString("session")!;
...
//     final res = callDbRequest(Uri.parse(url), createPayload({}));
//     return res;
//   }
